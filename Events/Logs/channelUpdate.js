  ...
  async execute(oldChannel, newChannel) {
    ...
    if (log.action == "CHANNEL_OVERWRITE_CREATE") { // If the last entry fetched is of the type "CHANNEL_OVERWRITE_CREATE" executes code
      ...
      const channelPermissionCreate = new MessageEmbed()
        .setColor("GREEN")
        .setTitle(`:recycle: A Permission Has Been Created In A Channel`)
        .setTimestamp()
      ...
      const channelPermissionUpdate = new MessageEmbed()
        .setColor("ORANGE")
        .setTitle(`:warning:  A Permission Has Been Updated In A Channel`)
        .setTimestamp()
      ...
      const channelPermissionDelete = new MessageEmbed()
        .setColor("RED")
        .setTitle(`:hotsprings: A Permission Has Been Deleted In A Channel`)
        .setTimestamp()
      ...
      const channelUpdateLogEmbed = new MessageEmbed()
        .setColor("ORANGE")
        .setTitle(`:warning: A Channel Has Been Updated`)
        .setTimestamp()
