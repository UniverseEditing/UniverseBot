      ...
      guild.channels.create(`🎫﹒submit ${interaction.user.username}`, {
        ...
        .then((channel) => {
          ...
          const e1 = new MessageEmbed()
            .setTitle("<a:bluecross:942516557412704256>  UNI Discord // DESIGN SUBMIT <a:bluecross:942516557412704256> ")
            ...
            .then((message) => {
              ...
              if (submitname.includes("exit")) {
                ...
                const e2 = new MessageEmbed()
                  .setTitle("<a:bluecross:942516557412704256>  UNI Discord // DESIGN SUBMIT <a:bluecross:942516557412704256> ")
                  .setDescription("**------------** \n> Enter \`exit\` to exit promt. \n> **Please enter your design`s link:** \n**------------** ")
                  .setColor("#ffffff")
                  .setTimestamp()
                  ...
                  .then((link) => {
                    ...
                    if (submitlink.includes("exit")) {
                      ...
                      const e3 = new MessageEmbed()
                        .setTitle("<a:bluecross:942516557412704256>  UNI Discord // DESIGN SUBMITTED <a:bluecross:942516557412704256> ")
