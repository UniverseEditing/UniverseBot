  ...
  async execute(interaction, client) {
    ...
    switch(interaction.options.getSubcommand()) {
      case "accept":
        ...
        return interaction.reply({embeds: [new MessageEmbed().setColor("#ffffff").setDescription(`> ✅ [Suggestion](${message.url}) was accepted.`)], ephemeral: true})
      break;
      ...
      case "decline":
        ...
        return interaction.reply({embeds: [new MessageEmbed().setColor("#ffffff").setDescription(`> ✅ [Suggestion](${message.url}) declined.`)], ephemeral: true})
      break;
      ...
      case "delete":
        if(!suggestSetup.AllowOwnSuggestionDelete && !suggestionManager) {
          ...
          return interaction.reply({embeds: [new MessageEmbed().setColor("#ffffff").setDescription(`> ✅ This suggestion was deleted.`)]})
        } else if(suggestSetup.AllowOwnSuggestionDelete) {
          if(suggestion.MemberID === interaction.member.id) {
            await message.delete()
            return interaction.reply({embeds: [new MessageEmbed().setColor("#ffffff").setDescription(`> ✅ Your suggestion was deleted.`)]})  
          } else {
